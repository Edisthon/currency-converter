...
| Backlog Item ID | User Story | Story Points | Priority | Sprint | Status | Acceptance Criteria |
| :--- | :--- | :---: | :---: | :---: | :---: | :--- |
| **US-03** | **As an admin, I want to be able to add a new currency and exchange rate, so that a user can be able to use it. | 3 | High | 2 | To Do | 1. A successful POST of a new currency with return status of 201 Created.<br>2. A return status 409 Conflict if currency already exists. |
